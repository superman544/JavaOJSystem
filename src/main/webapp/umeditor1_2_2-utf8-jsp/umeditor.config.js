...
(function() {
	...
	var URL = window.UMEDITOR_HOME_URL || (function() {
		...
		PathStack.prototype = {
			...
			toString : function() {
				return this.protocol
						+ (this.stack.concat([''])).join(this.separator);
			}
		};
		...
		function update() {
			...
			if (protocol) {
				...
				// local
				this.localSeparator = /\\|\//.exec(this.path.replace(protocol,
						''))[0];
	...
	window.UMEDITOR_CONFIG = {
		...
		toolbar : [
				...
				'link unlink | emotion', '| horizontal print  ', 'drafts',
				'formula']
